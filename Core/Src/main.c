...
int main(void)
{
  ...
  case 1:
   ...
   /*Extract time from the nmea string*/
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /**/
  LL_GPIO_ResetOutputPin(DATA1_GPIO_Port, DATA1_Pin);

  /**/
  LL_GPIO_ResetOutputPin(DATA2_GPIO_Port, DATA2_Pin);

  /**/
  LL_GPIO_ResetOutputPin(DISP_ENB_GPIO_Port, DISP_ENB_Pin);

  /**/
  LL_GPIO_ResetOutputPin(DOT_GPIO_Port, DOT_Pin);

  /**/
  LL_GPIO_ResetOutputPin(INT_GPIO_Port, INT_Pin);

  /**/
  LL_GPIO_ResetOutputPin(HH_TEN_GPIO_Port, HH_TEN_Pin);

  /**/
  LL_GPIO_ResetOutputPin(HH_UNIT_GPIO_Port, HH_UNIT_Pin);

  /**/
  LL_GPIO_ResetOutputPin(MM_TEN_GPIO_Port, MM_TEN_Pin);

  /**/
  LL_GPIO_ResetOutputPin(MM_UNIT_GPIO_Port, MM_UNIT_Pin);

  /**/
  LL_GPIO_ResetOutputPin(GPS_ON_GPIO_Port, GPS_ON_Pin);

  /**/
  LL_GPIO_ResetOutputPin(LED_BLINK_GPIO_Port, LED_BLINK_Pin);
  ...
  /**/
  GPIO_InitStruct.Pin = SS_TEN_IN_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(SS_TEN_IN_GPIO_Port, &GPIO_InitStruct);

  /**/
  GPIO_InitStruct.Pin = SS_UNIT_IN_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(SS_UNIT_IN_GPIO_Port, &GPIO_InitStruct);
  ...
  /**/
  GPIO_InitStruct.Pin = debug_35_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(debug_35_GPIO_Port, &GPIO_InitStruct);

  /**/
  GPIO_InitStruct.Pin = debug_36_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(debug_36_GPIO_Port, &GPIO_InitStruct);
  ...
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(LED_BLINK_GPIO_Port, &GPIO_InitStruct);
